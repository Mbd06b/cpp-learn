...
enum Suits {Hearts, Diamonds, Clubs, Spades}; // enum is an enumeration. Hearts is 0, Diamonds is 1, Clubs is 3 ...ectra...
...
void Show (Card &); // adding the & ampersand, this is now passing a reference to a structure, which is more efficient					//
void InitDeck (Card []);
