...
#include <iostream>
#include <ctype.h>  // this may be required to use the "isspace" NOT ACTUALLY NECESSARY HERE (linux GCC).
...
char * ReadString ()
{
	...
	while (!isspace(c = cin.get())) //cin.get gets the characters as you type them  (isspace is either TAB, SPACEBAR, ENTER).
	{
